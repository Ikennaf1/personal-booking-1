...
function getThemeDefaults()
{
    ...
    $userTitle = !empty(settings('r', 'personal_booking_1.user_title'))
        ? settings('r', 'personal_booking_1.user_title')
        : 'Copywriter';

    $userBio = !empty(settings('r', 'personal_booking_1.user_bio'))
        ? settings('r', 'personal_booking_1.user_bio')
    ...
    $ctaText = !empty(settings('r', 'personal_booking_1.cta_text'))
        ? settings('r', 'personal_booking_1.cta_text')
        : 'Book me';
